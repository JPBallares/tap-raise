...
// NULL is a valid whitebox key, and in fact is the only valid value for POS builds of LCR (as opposed to PaySDK, which
// require a non-NULL key).
...
/**
 ...
 @param server_error_message_out If the return value is CR_SECURESESSION_FEATURE_RESULT_SERVER_DENY_ERROR, this will
 contain additional information about the server deny. Should be ignored otherwise.
 @param server_ux_hint_out If the return value is CR_SECURESESSION_FEATURE_RESULT_SERVER_DENY_ERROR, this will contain
 additional information about the user experience for the error screen that will be display. Should be ignored
 otherwise.
 @param localized_title_out If the return value is CR_SECURESESSION_FEATURE_RESULT_SERVER_DENY_ERROR, this will contain
 the title string to display. Should be ignored otherwise.
 @param localized_title_out_len The length of the localized_title_out buffer
 @param localized_description_out If the return value is CR_SECURESESSION_FEATURE_RESULT_SERVER_DENY_ERROR, this will
 contain the description string to display. Should be ignored otherwise.
