...
/** Indicates a card's cobrand, such as AfterPay. */
typedef NS_ENUM(NSInteger, SQRDCardCoBrand) {
    /** An unidentified cobrand. */
    SQRDCardCoBrandOther = 0,
...
/**
 The card CoBrand (for example, AfterPay etc.).
 */
